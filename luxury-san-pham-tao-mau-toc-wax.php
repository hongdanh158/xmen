		...
		<div class="left wax">
			<div class="image">
				<video id="video-product" class="video-product" loop>
          			<source src="images/products/luxury/wax-vuot-toc.mp4" type="video/mp4">
        		</video>
				<img src="images/products/luxury/wax-vuot-toc.jpg" alt="">
			</div>
		</div>
		<div class="right">
			<h3 class="name">Wax Vuốt Tóc <br> X-Men For Boss Freestyle</h3>
			<div class="text">
				<p>Xmen For Boss Freestyle - Nếp tự nhiên, kiểu linh hoạt</p>
				<p>Sáp vuốt tóc Xmen for Boss Freestyle là sản phẩm chuyên biệt cho kiểu Vuốt Nhẹ Tự Nhiên nhờ khả năng giữ nếp bền mà không đơ cứng.</p>
			</div>
