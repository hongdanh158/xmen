	...
	<div class="products luxury" canvas="container">
		<div class="left gel">
			<div class="image">
				<video id="video-product" class="video-product" loop>
          			<source src="images/products/luxury/gel-vuot-toc.mp4" type="video/mp4">
        		</video>
				<img src="images/products/luxury/gel-vuot-toc.jpg" alt="">
			</div>
			<div class="sign">
		...
		<div class="right">
			...
			<div class="text">
				...
				<ul>
					<li>Nuôi dưỡng tóc chắc khỏe với Pro Vitamin B5.</li>
					<li>Hương nước hoa độc dáo và sang trọng của X-Men For Boss Jean-Francois Edition thể hiện phong cách tinh tế đầy lôi cuốn của người đàn ông thành đạt</li>
				</ul>
			</div>
