<?php include('header.php') ?>
	<div class="products intense" canvas="container">
		<div class="left roller roller-25">
			<div class="image">
				<video id="video-product" class="video-product" loop>
          			<source src="images/products/intense/lan-khu-mui-25ml.mp4" type="video/mp4">
        		</video>
				<img src="images/products/intense/lan-khu-mui-25ml.jpg" alt="">
			</div>
			<div class="sign">
