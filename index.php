				...
				<div class="slider-2 section-slider">
					<div class="content">
						...
						<div class="all-product">
				  		...
				  		<p class="text-2 center-align">Từ những nhà điều hương hàng đầu thế giới</p>
					</div>
				</div>
			</div>
			<a href="#secondPage" class="o-icon c-icon-scrolldown2">
				...
				<div class="video-wrapper">
					<div class="video-wrapper-inner">
						...
						<ul class="video-list c-carousel-v has-scroll">
		                    ...
		                    <li data-link="https://storage.googleapis.com/xmenmedia/video/0ba7640b-c965-474c-a736-5ccf9ea96272.mp4" data-poster="http://x-men.com.vn/static/default/frontend/tmp/xmen_boss/images/boss/poster_video5.jpg" class="nv5">
		                        <div class="wp-img"><img src="http://x-men.com.vn/static/default/frontend/tmp/xmen_boss/images/boss/thumb_video5.jpg" alt="x-men" class="img-responsive"/></div>
		                        <div class="caption-vd">
